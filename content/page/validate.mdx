      ...
      - title: ORGANISER
        blocks:
          ...
          - question: >-
            ...
            _template: BB_CheckerQuestion
          - question: Can you identify the organising institution(s) or company/ies
            answersList:
              - yes||
              - no||
            _template: BB_CheckerQuestion
          ...
          - question: >-
            ...
            _template: BB_CheckerQuestion
          - content: >
              *When evaluating the organising committee, it is not enough to
              just see names on a website. Sometimes predatory organisers make
              up names, make up institutions, or even steal legitimate names and
      ...
      - title: EVENT
        blocks:
          ...
          - question: >-
            ...
            _template: BB_CheckerQuestion
          - content: >
              *blurb on broad themed events to attract lots of people, don’t
              care about specific theme – of course sometimes want to invite
              everyone from wider field so theme is deliberately broad, but
              should still be specifically targeted at a key demographic.*


              *Red flags for event titles and themes can include:*


              * *does the event title have overly grandiose claims (ie 'world'
              or 'international')*
              ...
              * *claim to be latest in a long series of the event, but no record
              ...
              single year so 14th event is only occurring 3 yrs after 1st
              event)*

              * *very broad, with no clear contribution or guiding theme/focus*

              * *does it reference multiple unrelated subject fields in the
              title (eg the International conference or mathematics, humanities
              and medicine)*
            _template: BB_KeepInMind
        scoreBreakDown:
          - 8| Other message event discovery
        ...
        blocks:
          - width: w-full
            content: >
              ...
              There are a number of factors to consider when deciding whether or
              not to present your research at a particular conference. After
              all, typically a paper should contain new and original research
              that has not been published or presented previously – which means
              you only have one chance to present a particular piece of
              research, and you don’t want to waste it on a poor-quality
              conference.
            _template: BB_RichText
        ...
        blocks:
          ...
          - content: >
              *The nature and purpose of the conference helps to shape the type
              ...
              2. *An event designed for networking and collaboration will be
              more focused on social opportunities and workshops*
      ...
      - title: PUBLICATION
        blocks:
          - width: w-full
            ...
            _template: BB_RichText
          - question: >-
              If publishing is discussed is it for every paper or only for
              selected papers
            answersList:
              - 'yes'
              - 'no'
          ...
          - question: >-
            ...
            answersList:
              ...
              - 'no'
            _template: BB_CheckerQuestion
          - question: Do they conform to international academic best practices
            answersList:
              - 'yes'
              - 'no'
            _template: BB_CheckerQuestion
          - question: Or is publication guaranteed automatically
            answersList:
              - 'yes'
              - 'no'
            _template: BB_CheckerQuestion
          - question: >-
              Is a specific publication mentioned (a journal special issue or
              book series)
            answersList:
              - 'yes'
              - 'no'
            _template: BB_CheckerQuestion
          - question: Can these claims be verified (by publisher or journal)
            answersList:
              - 'yes'
              - 'no'
            _template: BB_CheckerQuestion
          ...
          - content: >
              *When considering the quality of a prospective publication or
              ...
              determining whether they are ethical, high quality and
              legitimate.*
              ...
              * *is the journal clear about its review and acceptance processes,
              and do these align with those outlined by the conference
              organsier*
